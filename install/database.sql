...
(217, 'SIGNAL_NOTICATION', 'Send Signal Notification', 'Signal Notification', '<div><span style=\"color: rgb(33, 37, 41);\">Package : {{package}}</span><b><br></b></div><div><span style=\"color: rgb(33, 37, 41);\">Validity: {{validity}}</span><span style=\"color: rgb(33, 37, 41);\"><br></span></div><div><span style=\"color: rgb(33, 37, 41);\">Signal Title: {{signal_name}}</span><span style=\"color: rgb(33, 37, 41);\"><br></span></div><div><b><br></b></div><div><b>Details:</b></div><div><span style=\"font-weight: bolder; color: rgb(33, 37, 41);\">{{signal_details}}</span><font size=\"4\"><b><br></b></font></div><div><br></div>', 'Package : {{package}}\r\nValidity: {{validity}}\r\nSignal Title: {{signal_name}}\r\n\r\nDetails:\r\n{{signal_details}}', '{\"package\":\"Package Name\",\"validity\":\"Validity Date Expired\",\"signal_name\":\"Signal Name\",\"signal_details\":\"Signal Details\"}', 1, 1, '2020-06-10 18:00:00', '2021-09-04 06:10:39'),
(218, 'PURCHASE_COMPLETE', 'Package Purchase - Successful', 'Package Purchased Successfully', '<div>Your have purchased&nbsp; <b>{{package}}</b>&nbsp; Successfully.<b><br></b></div><div><b><br></b></div><div><b>Details :<br></b></div><div>Amount : {{price}} {{currency}}</div><div>Transaction Number : {{trx}}</div><div><font size=\"5\"><b><br></b></font></div><div><font size=\"5\">Your current Balance is <b>{{post_balance}} {{currency}}</b></font></div><div><br></div><div><br><br><br></div>', 'Your have purchased  {{package}}  Successfully.\r\n\r\nDetails :\r\nAmount : {{price}} {{currency}}\r\nTransaction Number : {{trx}}\r\n\r\nYour current Balance is {{post_balance}} {{currency}}', '{\"trx\":\"Transaction Number\",\"package\":\"Package Name\",\"amount\":\"Package Price\",\"currency\":\"Site Currency\",\"post_balance\":\"Users Balance After this operation\",\"validity\":\"Day of Package Validity\",\"expired_validity\":\"User Expired Validity\",\"buy_at\":\"Purchased Date\"}', 1, 1, '2020-06-24 18:00:00', '2021-09-07 11:47:54'),
(219, 'RENEW_COMPLETE', 'Package Renew - Successful', 'Package Renewed Successfully', '<div>Your have purchased&nbsp; <b>{{package}}</b>&nbsp; Successfully.<b><br></b></div><div><b><br></b></div><div><b>Details :<br></b></div><div>Amount : {{amount}} {{currency}}</div><div>Transaction Number : {{trx}}</div><div><font size=\"5\"><b><br></b></font></div><div><font size=\"5\">Your current Balance is <b>{{post_balance}} {{currency}}</b></font></div><div><br></div><div><br><br><br></div>', 'Your have purchased  {{package}}  Successfully.\r\n\r\nDetails :\r\nAmount : {{amount}} {{currency}}\r\nTransaction Number : {{trx}}\r\n\r\nYour current Balance is {{post_balance}} {{currency}}', '{\"trx\":\"Transaction Number\",\"package\":\"Package Name\",\"amount\":\"Package Price\",\"currency\":\"Site Currency\",\"post_balance\":\"Users Balance After this operation\",\"validity\":\"Day of Package Validity\",\"expired_validity\":\"User Expired Validity\",\"renew_at\":\"Renewed Date\"}', 1, 1, '2020-06-24 18:00:00', '2021-09-07 12:06:27');
...
(1, 'tawk-chat', 'Tawk.to', 'Key location is shown bellow', 'tawky_big.png', '<script>\r\n                        var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();\r\n                        (function(){\r\n                        var s1=document.createElement(\"script\"),s0=document.getElementsByTagName(\"script\")[0];\r\n                        s1.async=true;\r\n                        s1.src=\"https://embed.tawk.to/{{app_key}}\";\r\n                        s1.charset=\"UTF-8\";\r\n                        s1.setAttribute(\"crossorigin\",\"*\");\r\n                        s0.parentNode.insertBefore(s1,s0);\r\n                        })();\r\n                    </script>', '{\"app_key\":{\"title\":\"App Key\",\"value\":\"------\"}}', 'twak.png', 0, NULL, '2019-10-18 23:16:05', '2021-09-07 05:42:57'),
(2, 'google-recaptcha2', 'Google Recaptcha 2', 'Key location is shown bellow', 'recaptcha3.png', '\r\n<script src=\"https://www.google.com/recaptcha/api.js\"></script>\r\n<div class=\"g-recaptcha\" data-sitekey=\"{{sitekey}}\" data-callback=\"verifyCaptcha\"></div>\r\n<div id=\"g-recaptcha-error\"></div>', '{\"sitekey\":{\"title\":\"Site Key\",\"value\":\"6Lfpm3cUAAAAAGIjbEJKhJNKS4X1Gns9ANjh8MfH\"}}', 'recaptcha.png', 0, NULL, '2019-10-18 23:16:05', '2021-09-06 05:21:41'),
(3, 'custom-captcha', 'Custom Captcha', 'Just Put Any Random String', 'customcaptcha.png', NULL, '{\"random_key\":{\"title\":\"Random String\",\"value\":\"SecureString\"}}', 'na', 0, NULL, '2019-10-18 23:16:05', '2021-09-07 05:43:00'),
(4, 'google-analytics', 'Google Analytics', 'Key location is shown bellow', 'google_analytics.png', '<script async src=\"https://www.googletagmanager.com/gtag/js?id={{app_key}}\"></script>\r\n                <script>\r\n                  window.dataLayer = window.dataLayer || [];\r\n                  function gtag(){dataLayer.push(arguments);}\r\n                  gtag(\"js\", new Date());\r\n                \r\n                  gtag(\"config\", \"{{app_key}}\");\r\n                </script>', '{\"app_key\":{\"title\":\"App Key\",\"value\":\"------\"}}', 'ganalytics.png', 0, NULL, NULL, '2021-09-07 05:43:02'),
(5, 'fb-comment', 'Facebook Comment ', 'Key location is shown bellow', 'Facebook.png', '<div id=\"fb-root\"></div><script async defer crossorigin=\"anonymous\" src=\"https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v4.0&appId={{app_key}}&autoLogAppEvents=1\"></script>', '{\"app_key\":{\"title\":\"App Key\",\"value\":\"----\"}}', 'fb_com.PNG', 0, NULL, NULL, '2021-09-07 05:42:55');
...
(1, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"SignalLab\",\"Forex Signal\",\"Crypto signal\"],\"description\":\"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit\",\"social_title\":\"SignalLab - Forex Signal Platform\",\"social_description\":\"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit ff\",\"image\":\"613cc0dab6ac41631371482.jpg\"}', '2020-07-04 23:42:52', '2021-09-11 08:44:42'),
(24, 'about.content', '{\"has_image\":\"1\",\"heading\":\"Over 52,000 traders worldwide trust SignalLab - now it\'s your turn\",\"sub_heading\":\"Grasp the markets with SignalLab\",\"description\":\"Nostrum facilis voluptatum voluptates sunt facere, distinctio ullam aspernatur cumque autem a esse non unde, nemo iusto! Voluptas molestiae velit dolores blanditiis.\",\"button_text\":\"Get Started\",\"button_url\":\"register\",\"image\":\"61333db1010691630748081.png\"}', '2020-10-28 00:51:20', '2021-09-04 09:04:41'),
(25, 'blog.content', '{\"heading\":\"Blog Post\",\"sub_heading\":\"Our Latest News\"}', '2020-10-28 00:51:34', '2021-09-04 12:14:56'),
(27, 'contact_us.content', '{\"heading\":\"Get in Touch\",\"sub_heading\":\"Amet consectetur adipisicing elit. Odit ipsa, blanditiis corrupti ut dolorem dolore consequatur quod inventore illum sapiente odio eius.\",\"address\":\"Syed Mahbub Morshed Avenue Sher-E-Bangla Nagar, Dhaka 1207 Bangladesh\",\"google_map\":\"https:\\/\\/goo.gl\\/maps\\/zL1MU325Qmb9e4kX9\"}', '2020-10-28 00:59:19', '2021-09-04 14:02:31'),
(28, 'counter.content', '{\"heading\":\"Latest News\",\"sub_heading\":\"Register New Account\"}', '2020-10-28 01:04:02', '2020-10-28 01:04:02'),
(31, 'social_icon.element', '{\"title\":\"Facebook\",\"social_icon\":\"<i class=\\\"lab la-facebook-f\\\"><\\/i>\",\"url\":\"https:\\/\\/www.facebook.com\\/\"}', '2020-11-12 04:07:30', '2021-09-04 08:58:19'),
...
(39, 'banner.content', '{\"has_image\":\"1\",\"title\":\"Track your singnals and improve your trading\",\"heading\":\"Learn To Trade World\\u2019s Best Forex Signal Provider\",\"sub_heading\":\"You need tested strategies, powerful tools, and experienced traders to arm you with knowledge. That\'s where we come in.\",\"button_text\":\"Join Us Now\",\"button_url\":\"login\",\"image\":\"6133353c117981630745916.jpg\"}', '2021-05-02 06:09:30', '2021-09-09 14:07:18'),
(41, 'cookie.data', '{\"link\":\"#\",\"description\":\"<font color=\\\"#FFFFCC\\\"><span style=\\\"background-color: rgb(0, 0, 0);\\\"><font face=\\\"Exo, sans-serif\\\"><span style=\\\"font-size: 18px;\\\">We may use cookies or any other tracking technologies when you visit our website, including any other media form, mobile website, or mobile application related or connected to help customize the Site and improve your experience.<\\/span><\\/font><\\/span><br><\\/font>\",\"status\":1}', '2020-07-04 23:42:52', '2021-09-11 08:46:28'),
...
(44, 'social_icon.element', '{\"title\":\"Google\",\"social_icon\":\"<i class=\\\"fab fa-google\\\"><\\/i>\",\"url\":\"http:\\/\\/www.google.com\\/\"}', '2021-09-04 08:58:47', '2021-09-04 08:58:47'),
(45, 'about.element', '{\"feature\":\"Recieve market analasis from well-seasoned Forex mentors.\"}', '2021-09-04 09:08:38', '2021-09-04 09:08:38'),
(46, 'about.element', '{\"feature\":\"Join daily live streams and review Forex currency pairs in realtime\"}', '2021-09-04 09:08:43', '2021-09-04 09:08:43'),
(47, 'about.element', '{\"feature\":\"Share your own trade ideas and analasis with traders inside of the Trading Room\"}', '2021-09-04 09:08:48', '2021-09-04 09:08:48'),
(48, 'how_it_work.content', '{\"heading\":\"How it Works\",\"sub_heading\":\"Get started in only a few minnutes\"}', '2021-09-04 09:12:16', '2021-09-04 09:12:16'),
(49, 'how_it_work.element', '{\"has_image\":\"1\",\"title\":\"Register an Account\",\"image\":\"61333f870f4ea1630748551.png\"}', '2021-09-04 09:12:31', '2021-09-04 09:12:31'),
(50, 'how_it_work.element', '{\"has_image\":\"1\",\"title\":\"Getting analysis result via Email &amp; SMS notification\",\"image\":\"61333f8de2ff31630748557.png\"}', '2021-09-04 09:12:37', '2021-09-04 09:12:38'),
(51, 'how_it_work.element', '{\"has_image\":\"1\",\"title\":\"Start Trading\",\"image\":\"61333f9591efa1630748565.png\"}', '2021-09-04 09:12:45', '2021-09-04 09:12:45'),
(52, 'why_choose_us.content', '{\"heading\":\"Why CHoose Us\",\"sub_heading\":\"Everything you need to fast track your trading\"}', '2021-09-04 09:16:09', '2021-09-04 09:16:09'),
(53, 'why_choose_us.element', '{\"title\":\"Top technical analysis\",\"description\":\"Ullam minus nihil delectus, voluptatum ab sunt maxi harum possimus sit ea quasi quas non aliquam deb velit atque explicabo tenetur. Ipsam molestiae culpa.\",\"icon\":\"<i class=\\\"las la-chart-line\\\"><\\/i>\"}', '2021-09-04 09:19:48', '2021-09-04 09:22:26'),
(54, 'why_choose_us.element', '{\"title\":\"High performance\",\"description\":\"Ullam minus nihil delectus, voluptatum ab sunt maxi harum possimus sit ea quasi quas non aliquam deb velit atque explicabo tenetur. Ipsam molestiae culpa.\",\"icon\":\"<i class=\\\"fas fa-rocket\\\"><\\/i>\"}', '2021-09-04 09:20:06', '2021-09-04 09:22:15'),
(55, 'overview.content', '{\"heading\":\"Company Growth\",\"sub_heading\":\"Our Company Growth\"}', '2021-09-04 09:23:37', '2021-09-04 09:23:37'),
(56, 'overview.element', '{\"title\":\"3-7\",\"text\":\"v\",\"icon\":\"<i class=\\\"far fa-copy\\\"><\\/i>\"}', '2021-09-04 09:25:17', '2021-09-04 09:25:17'),
(57, 'overview.element', '{\"title\":\"450\",\"text\":\"Pips - Monthly Target\",\"icon\":\"<i class=\\\"las la-user\\\"><\\/i>\"}', '2021-09-04 09:25:33', '2021-09-04 09:25:33'),
(58, 'overview.element', '{\"title\":\"5+\",\"text\":\"Years Experience\",\"icon\":\"<i class=\\\"fas fa-business-time\\\"><\\/i>\"}', '2021-09-04 09:25:50', '2021-09-04 09:25:50'),
(59, 'package.content', '{\"heading\":\"Our Packages\",\"sub_heading\":\"Unlock Daily Forex Signals\"}', '2021-09-04 09:43:36', '2021-09-04 09:43:36'),
(60, 'testimonial.content', '{\"heading\":\"We are only as good as our clients say we are\",\"sub_heading\":\"Saepe ullam mollitia quaerat, aut atque error labore voluptates ad consectetur doloribus dolore laudantium ab optio nemo impedit numquam sed unde eius vero.\"}', '2021-09-04 09:51:39', '2021-09-04 09:51:39'),
(61, 'testimonial.element', '{\"has_image\":\"1\",\"name\":\"Md Zahidul Islam\",\"rating\":\"3\",\"say\":\"Consectetur, saepe nesciunt! Quaerat tenetur adipisci voluptatum incidunt illum rerum exercitationem animit.\",\"image\":\"613349d9e85351630751193.jpg\"}', '2021-09-04 09:56:33', '2021-09-04 09:56:34'),
(62, 'faq.content', '{\"heading\":\"Frequently Asked Questions\",\"sub_heading\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad voluptatum fuga eius expedita, nulla quos blanditiis nobis laboriosam. Natus cum eum fuga praesentium.\"}', '2021-09-04 10:01:35', '2021-09-04 10:01:35'),
(63, 'faq.element', '{\"question\":\"Tenetur et facilis, quia veritatis temporibus.\",\"answer\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque perspiciatis harum voluptatibus natus alias nesciunt eius similique tenetur corporis fuga eligendi in enim quisquam dolor voluptates nihil obcaecati pariatur commodi facilis, officiis nobis porro eum architecto! Delectus ut voluptatibus voluptatem, aliquam tenetur et facilis, quia veritatis temporibus, ex magni soluta.\"}', '2021-09-04 10:18:06', '2021-09-04 10:18:06'),
(64, 'faq.element', '{\"question\":\"Lorem ipsum dolor sit amet consectetur\",\"answer\":\"Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque perspiciatis harum voluptatibus natus alias nesciunt eius similique tenetur corporis fuga eligendi in enim quisquam dolor voluptates nihil obcaecati pariatur commodi facilis, officiis nobis porro eum architecto! Delectus ut voluptatibus voluptatem, aliquam tenetur et facilis, quia veritatis temporibus, ex magni soluta.\"}', '2021-09-04 10:18:16', '2021-09-04 10:19:40'),
(65, 'cta.content', '{\"has_image\":\"1\",\"title\":\"Are you ready to take your trading to the next level\",\"button_text\":\"Join with Us\",\"button_url\":\"register\",\"image\":\"613350c247e401630752962.jpg\"}', '2021-09-04 10:22:38', '2021-09-04 10:26:02'),
(66, 'subscribe.content', '{\"heading\":\"Subscribe to our newsletter to get updated.\",\"button_text\":\"Subscribe\"}', '2021-09-04 10:27:29', '2021-09-04 10:27:29'),
(68, 'breadCrumb.content', '{\"has_image\":\"1\",\"image\":\"6133730132d441630761729.jpg\"}', '2021-09-04 12:52:09', '2021-09-04 12:52:09'),
(69, 'policy_pages.element', '{\"title\":\"Terms of Condition\",\"details\":\"<div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">What information do we collect?<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">We gather data from you when you register on our site, submit a request, buy any services, react to an overview, or round out a structure. At the point when requesting any assistance or enrolling on our site, as suitable, you might be approached to enter your: name, email address, or telephone number. You may, nonetheless, visit our site anonymously.<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">How do we protect your information?<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">All provided delicate\\/credit data is sent through Stripe.<br \\/>After an exchange, your private data (credit cards, social security numbers, financials, and so on) won\'t be put away on our workers.<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">Do we disclose any information to outside parties?<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">We don\'t sell, exchange, or in any case move to outside gatherings by and by recognizable data. This does exclude confided in outsiders who help us in working our site, leading our business, or adjusting you, since those gatherings consent to keep this data private. We may likewise deliver your data when we accept discharge is suitable to follow the law, implement our site strategies, or ensure our own or others\' rights, property, or wellbeing.<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">Children\'s Online Privacy Protection Act Compliance<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">We are consistent with the prerequisites of COPPA (Children\'s Online Privacy Protection Act), we don\'t gather any data from anybody under 13 years old. Our site, items, and administrations are completely coordinated to individuals who are in any event 13 years of age or more established.<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">Changes to our Privacy Policy<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">If we decide to change our privacy policy, we will post those changes on this page.<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">How long we retain your information?<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">At the point when you register for our site, we cycle and keep your information we have about you however long you don\'t erase the record or withdraw yourself (subject to laws and guidelines).<\\/p><\\/div><div class=\\\"mb-5\\\" style=\\\"margin-bottom:3rem;color:rgb(111,111,111);font-family:Nunito, sans-serif;\\\"><h3 class=\\\"mb-3\\\" style=\\\"font-weight:600;line-height:1.3;font-size:24px;color:rgb(54,54,54);font-family:Exo, sans-serif;\\\">What we don\\u2019t do with your data<\\/h3><p class=\\\"font-18\\\" style=\\\"margin-right:0px;margin-left:0px;font-size:18px;\\\">We don\'t and will never share, unveil, sell, or in any case give your information to different organizations for the promoting of their items or administrations.<\\/p><\\/div>\"}', '2021-09-04 13:49:34', '2021-09-04 13:49:34'),
(70, 'contact_us.element', '{\"address\":\"Syed Mahbub Morshed Avenue Sher-E-Bangla Nagar, Dhaka 1207 Bangladesh\",\"icon\":\"<i class=\\\"fas fa-map-marker-alt\\\"><\\/i>\"}', '2021-09-06 05:00:17', '2021-09-06 05:00:17'),
(71, 'contact_us.element', '{\"address\":\"support@democompany.com\",\"icon\":\"<i class=\\\"far fa-envelope\\\"><\\/i>\"}', '2021-09-06 05:00:30', '2021-09-06 05:00:30'),
(72, 'contact_us.element', '{\"address\":\"+123645678915\",\"icon\":\"<i class=\\\"las la-phone\\\"><\\/i>\"}', '2021-09-06 05:00:39', '2021-09-06 05:00:39'),
(73, 'auth_image.content', '{\"has_image\":\"1\",\"image_one\":\"6135af04da7d91630908164.png\",\"image_two\":\"6135b0f0beb091630908656.png\"}', '2021-09-06 05:32:44', '2021-09-06 05:40:57'),
(74, 'why_choose_us.element', '{\"title\":\"Full expert support\",\"description\":\"Ullam minus nihil delectus, voluptatum ab sunt maxi harum possimus sit ea quasi quas non aliquam deb velit atque explicabo tenetur. Ipsam molestiae culpa.\",\"icon\":\"<i class=\\\"las la-headphones-alt\\\"><\\/i>\"}', '2021-09-09 13:46:17', '2021-09-09 13:46:17'),
(75, 'testimonial.element', '{\"has_image\":\"1\",\"name\":\"Sayara Saniya\",\"rating\":\"5\",\"say\":\"Consectetur, saepe nesciunt! Quaerat tenetur adipisci voluptatum incidunt illum rerum exercitationem animit.\",\"image\":\"613a178604d651631197062.jpg\"}', '2021-09-09 13:47:42', '2021-09-09 13:47:42'),
(76, 'faq.element', '{\"question\":\"It is a long established fact that a reader will be distracted\",\"answer\":\"e readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by\"}', '2021-09-09 13:48:54', '2021-09-09 13:48:54'),
(77, 'faq.element', '{\"question\":\"Contrary to popular belief, Lorem Ipsum is not simply random text.\",\"answer\":\"There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don\'t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure\"}', '2021-09-09 13:49:24', '2021-09-09 13:49:24'),
(78, 'social_icon.element', '{\"social_icon\":\"<i class=\\\"fab fa-twitter\\\"><\\/i>\",\"url\":\"https:\\/\\/www.twitter.com\\/\"}', '2021-09-09 13:50:46', '2021-09-09 13:50:46'),
(79, 'social_icon.element', '{\"social_icon\":\"<i class=\\\"fab fa-instagram\\\"><\\/i>\",\"url\":\"https:\\/\\/www.instagram.com\\/\"}', '2021-09-09 13:51:08', '2021-09-09 13:51:08');
...
CREATE TABLE IF NOT EXISTS `general_settings` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `dark_template` tinyint(1) NOT NULL DEFAULT 0,
  `api_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Telegram Bot API Token',
...
INSERT INTO `general_settings` (`id`, `dark_template`, `api_token`, `sitename`, `cur_text`, `cur_sym`, `email_from`, `email_template`, `sms_api`, `base_color`, `secondary_color`, `mail_config`, `sms_config`, `ev`, `en`, `sv`, `sn`, `force_ssl`, `secure_password`, `agree`, `registration`, `active_template`, `sys_version`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 'SignalLab', 'USD', '$', 'do-not-reply@viserlab.com', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello {{fullname}} ({{username}})</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\">{{message}}</td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">Website Name</a> . All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'hi {{name}}, {{message}}', 'FB3640', '0d222b', '{\"name\":\"php\"}', '{\"clickatell_api_key\":\"----------------------------\",\"infobip_username\":\"--------------\",\"infobip_password\":\"----------------------\",\"message_bird_api_key\":\"-------------------\",\"nexmo_api_key\":\"xxxxxxxxxxxxxxxxxxxxxx\",\"nexmo_api_secret\":\"xxxxxxxxxxxxxxxxxxxxxxxxxxx\",\"account_sid\":\"AC67afdacf2dacff5f163134883db92c24\",\"auth_token\":\"77726b242830fb28f52fb08c648dd7a6\",\"from\":\"+17739011523\",\"apiv2_key\":\"dfsfgdfgh\",\"name\":\"nexmo\"}', 0, 1, 0, 0, 0, 0, 1, 1, 'basic', NULL, NULL, '2021-09-11 08:44:55');
...
(1, 'HOME', 'home', 'templates.basic.', '[\"about\",\"how_it_work\",\"why_choose_us\",\"overview\",\"package\",\"testimonial\",\"faq\",\"cta\",\"blog\",\"subscribe\"]', 1, '2020-07-11 06:23:58', '2021-09-04 08:22:10'),
(2, 'About', 'about', 'templates.basic.', '[\"about\",\"why_choose_us\",\"overview\",\"testimonial\",\"faq\",\"cta\"]', 0, '2021-09-04 13:30:31', '2021-09-04 13:43:00'),
(3, 'Blog', 'blogs', 'templates.basic.', '[\"blog\",\"subscribe\"]', 0, '2021-09-04 13:32:39', '2021-09-04 13:42:22'),
(4, 'Packages', 'package', 'templates.basic.', '[\"faq\"]', 1, '2021-09-04 13:32:39', '2021-09-04 13:42:22'),
(5, 'Contact', 'contact', 'templates.basic.', NULL, 1, '2021-09-04 13:32:39', '2021-09-04 13:42:22');
...
CREATE TABLE IF NOT EXISTS `signals` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `send_via` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `signal` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `plan_id` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `minute` int(11) NOT NULL COMMENT 'Signal Send Duration',
  `status` tinyint(4) NOT NULL DEFAULT 1,
  `send` tinyint(1) DEFAULT NULL COMMENT '0=>Not Send, 1=>Send\r\n',
