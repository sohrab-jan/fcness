...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::get('/signal/history', 'UserController@signalHistory')->name('signal.history');

            Route::post('/buy/package', 'UserController@buyPackage')->name('buy.package');
            Route::post('/renew/package', 'UserController@renewPackage')->name('renew.package');
