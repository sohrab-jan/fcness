            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label class="form-control-label font-weight-bold"> @lang('Telegram Bot Api Token')</label>
                            <a href="javascript:void(0)" class="form-control-label font-weight-bold view">@lang('View Details')</a>
                            <input type="text" class="form-control form-control-lg" name="api_token" value="{{ $general->api_token }}"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label class="form-control-label font-weight-bold">@lang('Dark Template')</label>
                            <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Enable')" data-off="@lang('Disabled')" name="dark_template" @if($general->dark_template) checked @endif>
                        </div>
                        <div class="form-group col-md-4">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('Telegram Bot Settings')</h5>
            ...
            <form action="{{ route('admin.package.add') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step One')</label>
                            <label class="font-weight-bold">@lang('Install Telegram App')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Two')</label>
                            <label class="font-weight-bold">@lang('Open App and Search for BotFather')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Three')</label>
                            <label class="font-weight-bold">@lang('Start Conversion As /newbot')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Four')</label>
                            <label class="font-weight-bold">@lang('Chose a Bot Name and Press Enter')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Five')</label>
                            <label class="font-weight-bold">@lang('Choose a username for your bot. It must end in `bot`. Like this, for example: TetrisBot or tetris_bot')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Six')</label>
                            <label class="font-weight-bold">@lang('Bot will give you your BOT URL and API Key. Copy This and Paste Bellow')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Seven')</label>
                            <label class="font-weight-bold">@lang('Write your Bot Description using /setdescription')</label>
                        </div>
                        <div class="col-lg-12">
                            <label class="d-block">@lang('Step Eight')</label>
                            <label class="font-weight-bold">@lang('Set Bot Privacy using /setprivacy')</label>
                        </div>
                    </div>
                </div>
