    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive(['admin.signal', 'admin.signal.update.page'])}}">
                    <a href="{{route('admin.signal')}}" class="nav-link ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.report*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive(['admin.report.signal.history'])}}">
                                <a href="{{route('admin.report.signal.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
