            ...
            <div class="row mb-none-30">
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                    <div class="widget-three box--shadow2 b-radius--5 bg--danger text-white">
                        <div class="widget-three__content">
                            <h2 class="numbers text-white">{{ $totalPackage }}</h2>
                            <p class="text--small">@lang('Total Package')</p>
                            <h2 class="numbers text-white"><br>{{ $totalEnablePackage }}</h2>
                            <p class="text--small">@lang('Total Enable Package')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-30">
                   <a href="{{ route('admin.report.signal.history') }}">
                        <div class="widget-three box--shadow2 b-radius--5 bg--white">
                            <div class="widget-three__icon b-radius--rounded bg--warning  box--shadow2">
                                <i class="las la-signal"></i>
                            </div>
                            <div class="widget-three__content">
                                <h2 class="numbers">{{ $totalSendSignal }}</h2>
                                <p class="text--small">@lang('Total Send Signal')</p>
                            </div>
                        </div><!-- widget-two end -->
                   </a>
                </div>
