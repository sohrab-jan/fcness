...
@section('panel')
    <div class="row mb-none-30">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="font-weight-bold">
                                {{ $user->package_id != 0 ? __(@$user->package->name) : __('N/A') }}
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Validity')
        ...
        <div class="col-xl-9 col-lg-7 col-md-7 mb-30">
            ...
            <div class="row mb-none-30">
                <div class="col-xl-4 col-lg-6 col-sm-12 mb-30">
                ...
                <div class="col-xl-4 col-lg-6 col-sm-12 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.users.signal.history', $user->id) }}" class="item--link"></a>
                        <div class="icon">
