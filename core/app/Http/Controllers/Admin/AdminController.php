...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $totalEnablePackage = Package::where('status', 1)->count();
        $totalSendSignal = SignalHistory::count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'report', 'chart','payment','depositsMonth','months','deposits', 'totalPackage', 'totalEnablePackage', 'totalSendSignal'));
    }
