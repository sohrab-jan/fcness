...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $countSignal = SignalHistory::where('user_id', $user->id)->count();
        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','totalTransaction','countries', 'countSignal'));
    }
    ...
    public function signalHistory($id){
        $user = User::findOrFail($id);
        $pageTitle = 'Signal History of '.$user->username;
        $signals = SignalHistory::where('user_id', $user->id)->latest()->paginate(getPaginate());
        $emptyMessage = 'Data Not Found';
        return view('admin.users.signal_history', compact('pageTitle', 'signals', 'emptyMessage'));
    }
