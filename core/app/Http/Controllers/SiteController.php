...
class SiteController extends Controller
{
    ...
    public function packages(){
        $pageTitle = 'Packages';
        $packages = Package::where('status', 1)->paginate(getPaginate());
        $extends = Auth::user() ? $this->activeTemplate.'layouts.master' : $this->activeTemplate.'layouts.frontend';
        $sections = Page::where('tempname',$this->activeTemplate)->where('slug','package')->first();
        return view($this->activeTemplate.'package',compact('pageTitle', 'packages', 'extends','sections'));
    }
